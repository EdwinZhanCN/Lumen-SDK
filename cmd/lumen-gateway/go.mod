module github.com/edwinzhancn/lumen-sdk/cmd/lumen-gateway

go 1.25.0

// The gateway must ship the SDK from this checkout (it serves pkg/server/rest
// routes, including /v1/nodes/watch), not a previously released version.
