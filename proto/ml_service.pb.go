...
const (
	...
	ErrorCode_ERROR_CODE_UNAVAILABLE       ErrorCode = 2 // Downstream/hardware/resource unavailable
...
func (ErrorCode) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_ml_service_proto_enumTypes[0].Descriptor()
}

func (ErrorCode) Type() protoreflect.EnumType {
	return &file_proto_ml_service_proto_enumTypes[0]
}
...
type Error struct {
	...
	Detail        string                 `protobuf:"bytes,3,opt,name=detail,proto3" json:"detail,omitempty"` // For logging/troubleshooting (stack, node ID, etc.)
...
type InferRequest struct {
	...
	Seq           uint64 `protobuf:"varint,6,opt,name=seq,proto3" json:"seq,omitempty"`                                   // Chunk index (starting at 0)
	Total         uint64 `protobuf:"varint,7,opt,name=total,proto3" json:"total,omitempty"`                               // Optional: total number of chunks (omit if unknown)
	Offset        uint64 `protobuf:"varint,8,opt,name=offset,proto3" json:"offset,omitempty"`                             // Optional: byte offset of payload in the overall stream
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type InferResponse struct {
	...
	IsFinal       bool                   `protobuf:"varint,2,opt,name=is_final,json=isFinal,proto3" json:"is_final,omitempty"`                                                     // Streaming partials or final result
	Result        []byte                 `protobuf:"bytes,3,opt,name=result,proto3" json:"result,omitempty"`                                                                       // Result bytes; if JSON, specify via result_mime
	Meta          map[string]string      `protobuf:"bytes,4,rep,name=meta,proto3" json:"meta,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // e.g., lat_ms, tokens, bboxes_count
	Error         *Error                 `protobuf:"bytes,5,opt,name=error,proto3" json:"error,omitempty"`                                                                         // Populated only on failure (fatal errors may also terminate the stream)
	// --- Added: output content type and chunking control ---
	Seq           uint64 `protobuf:"varint,6,opt,name=seq,proto3" json:"seq,omitempty"`                                       // Chunk index (starting at 0), used for incremental/audio/video chunks
	Total         uint64 `protobuf:"varint,7,opt,name=total,proto3" json:"total,omitempty"`                                   // Optional: total number of chunks
	Offset        uint64 `protobuf:"varint,8,opt,name=offset,proto3" json:"offset,omitempty"`                                 // Optional: byte offset of result in the overall output
	...
	ResultSchema  string `protobuf:"bytes,10,opt,name=result_schema,json=resultSchema,proto3" json:"result_schema,omitempty"` // Optional: explicit schema name (e.g., "bbox_v1","mask_rle_v1")
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_ml_service_proto_rawDesc = "" +
	"\n" +
	"\x16proto/ml_service.proto\x12\x0ehome_native.v1\x1a\x1bgoogle/protobuf/empty.proto\"h\n" +
	"\x05Error\x12-\n" +
	...
	"\x06Health\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.EmptyB\bZ\x06proto/b\x06proto3"
...
var file_proto_ml_service_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_proto_ml_service_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
func file_proto_ml_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_proto_ml_service_proto_enumTypes,
